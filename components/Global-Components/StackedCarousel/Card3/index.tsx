            ...
            <div className="hidden w-full h-full lg:grid lg:grid-cols-2">
              <div className="flex flex-col justify-around gap-8 p-8 ">
                <div className="flex items-center gap-2">
                  ...
                  >
                    {data.howWeWork.content[2].title}
                  </motion.h1>
                </div>
                <motion.p
                  initial="hidden"
                ...
                >
                  {data.howWeWork.content[2].description}
                </motion.p>
              </div>
              <div className="relative hidden overflow-hidden md:hidden lg:block xl:block">
                ...
                <motion.img
                  ...
                  src={data.howWeWork.content[2].image}
                  alt={data.howWeWork.content[2].image}
