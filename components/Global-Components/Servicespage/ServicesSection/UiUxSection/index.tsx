  ...
  return (
    <section className="flex flex-col items-center space-y-4">
      <motion.div
        ...
        // }}
        className="relative w-full h-full  landscape:md:h-[calc(100vh_+_20rem)] portrait:md:h-screen"
        id="ui-ux"
      >
